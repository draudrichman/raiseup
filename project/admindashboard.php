...
<body>
  <div class="sidebar">
    <div class="logo-details">
      <span class="logo_name">StartUp</span>
    </div>
      <ul class="nav-links">
        <li>
          <a href="#" class="active">
      ...
      <div class="sales-boxes">
        <div class="recent-sales box">
          ...
          <ul class="details">
            ...
            <li><a href="#">$68.95</a></li>
            <li><a href="#">$42.56</a></li>
        ...
        <div class="top-sales box">
          ...
          <ul class="top-sales-details">
            <li>
            <a href="#">
              <span class="product">TeamSeas by Mr Beast</span>
            </a>
            <span class="price">$102,107</span>
          </li>
          <li>
            <a href="#">
              <span class="product">Support Da Vinci</span>
            </a>
            <span class="price">$1567</span>
          </li>
          <li>
            <a href="#">
              <span class="product">Raising money for Food in Africa</span>
            </a>
