<?php
  ...
  if(isset($_POST["createcampaign"])){
    ...
    $image = $_POST["imagelink"];
       ...
       $query = "INSERT INTO campaign (userID, title, description, goalAmount, currentAmount, statusID, currency, categoryID, image) VALUES ('$id', '$title', '$description', '$goal', '0', '1', '$currency', '$category', '$image')";
